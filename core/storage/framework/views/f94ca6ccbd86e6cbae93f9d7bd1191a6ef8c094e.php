<?php $__env->startSection('panel'); ?>
    <div class="row mb-none-30 justify-content-center">
            ...
            <div class="card b-radius--10 overflow-hidden box--shadow1">
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <?php echo app('translator')->get('Patient Payable '); ?>
        ...
        <div class="col-xl-6 col-md-6 mb-30">
            <div class="card b-radius--10 overflow-hidden box--shadow1">
                <div class="card-body">
                    <h5 class="mb-20 text-muted"><?php echo app('translator')->get('Appointment Details'); ?></h5>
                    <ul class="list-group">
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <?php echo app('translator')->get('Patient Name'); ?>
                            <span class="fw-bold"><?php echo e(__(@$deposit->appointment->name)); ?></span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <?php echo app('translator')->get('Email'); ?>
                            <span class="fw-bold"><?php echo e(@$deposit->appointment->email); ?></span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <?php echo app('translator')->get('Mobile No'); ?>
                            <span class="fw-bold"><?php echo e(@$deposit->appointment->mobile); ?></span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <?php echo app('translator')->get('Age'); ?>
                            <span class="fw-bold"><?php echo e(@$deposit->appointment->age); ?></span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <?php echo app('translator')->get('Doctor'); ?>
                            <span class="fw-bold">
                                <a href="<?php echo e(route('admin.doctor.detail', $deposit->doctor_id)); ?>"><?php echo e(@$deposit->doctor->name); ?></a>
                            </span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <?php echo app('translator')->get('Preferred Date'); ?>
                            <span class="fw-bold"><?php echo e(showDateTime(@$deposit->appointment->booking_date, 'Y-m-d')); ?></span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <?php echo app('translator')->get('Preferred Time or Serial'); ?>
                            <span class="fw-bold"><?php echo e(@$deposit->appointment->time_serial); ?></span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <?php echo app('translator')->get('Added By'); ?>
                            <span class="fw-bold">
                                <?php if(@$deposit->appointment->added_staff_id): ?>
                                    <a href="<?php echo e(route('admin.staff.detail', $deposit->appointment->staff->id)); ?>"><?php echo e(__(@$deposit->appointment->staff->name)); ?></a>
                                        <br> <span class="text--small badge badge--primary"><?php echo app('translator')->get('Staff'); ?></span>
                                <?php elseif(@$deposit->appointment->added_assistant_id): ?>
                                    <a href="<?php echo e(route('admin.assistant.detail', $deposit->appointment->assistant->id)); ?>"> <?php echo e(__(@$deposit->appointment->assistant->name)); ?></a>
                                    <br> <span class="text--small badge badge--dark"><?php echo app('translator')->get('Assistant'); ?></span>
                                <?php elseif(@$deposit->appointment->added_doctor_id): ?>
                                    <a href="<?php echo e(route('admin.doctor.detail', $deposit->appointment->doctor->id)); ?>"> <?php echo e(__(@$deposit->appointment->doctor->name)); ?></a>
                                    <br> <span class="text--small badge badge--success"><?php echo app('translator')->get('Doctor'); ?></span>
                                <?php elseif(@$deposit->appointment->added_admin_id): ?>
                                    <span class="text--small badge badge--primary"><?php echo app('translator')->get('Admin'); ?></span>
                                <?php elseif(@$deposit->appointment->site): ?>
                        ...
                        <li class="list-group-item">
                            ...
                            <br>
                            <p><?php echo e(__(@$deposit->appointment->disease)); ?></p>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <?php if($details || $deposit->status == Status::PAYMENT_PENDING): ?>
        <div class="row mb-none-30 justify-content-center">
            <div class="col-xl-12 col-md-12 mt-30">
                <div class="card b-radius--10 overflow-hidden box--shadow1">
                    <div class="card-body">
                        <h5 class="card-title mb-50 border-bottom pb-2"><?php echo app('translator')->get('Payment Information'); ?></h5>
                        <?php if($details != null): ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u549211671/domains/cfuat.in/public_html/kerfapthost/core/resources/views/admin/deposit/detail.blade.php ENDPATH**/ ?>