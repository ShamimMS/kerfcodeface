<?php $__env->startSection('panel'); ?>
    <div class="row mb-none-30">
        <div class="col-xl-3 col-lg-4 mb-30">
            ...
            <div class="card b-radius--5 overflow-hidden mt-4">
                <div class="card-body p-0">
                    <h3 class="p-3"><?php echo app('translator')->get('Doctor Information'); ?></h3>
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <a href="<?php echo e(route('admin.doctor.detail', $doctor->id)); ?>"><span
                                    class="fw-bold"><?php echo e($doctor->username); ?></span></a>
                        </li>
        ...
        <div class="col-xl-9 col-lg-8 mb-30">
            <form action="<?php echo e(route('admin.appointment.store', $doctor->id)); ?>" method="post">
                <?php echo csrf_field(); ?>
                        ...
                        <div class="p-3 bg--white">
                            ...
                            <div class="time-serial-parent mt-3">
                                <?php $__currentLoopData = $doctor->serial_or_slot; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <button type="button" class="btn btn--primary mr-2 mb-2 available-time item-<?php echo e(slug($item)); ?>"
    ...
    <script>
        (function($) {
            ...
            $("select[name=booking_date]").on('change', function() {
                ...
                let url = "<?php echo e(route('admin.appointment.available.date')); ?>";
                let data = {
                    date: $(this).val(),
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u549211671/domains/cfuat.in/public_html/kerfapthost/core/resources/views/admin/appointment/booking.blade.php ENDPATH**/ ?>